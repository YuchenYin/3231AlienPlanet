...
// Reference from https://github.com/leonjovanovic/water-shader-unity
{
    Properties
    {
    ...
    SubShader
    {
        ...
        //sample twice same texture for more realistic caustics movement
        ...
        //split RGB components to get that effect.
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            if (IN.worldPos.y < _MaxHeight)
                ...
                // add second multiplicator to fade caustics as it is closer to _MaxHeight
